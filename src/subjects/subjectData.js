...
export const subjects = [
  ...
  },
  {
    ...
    whatTutorsLookFor: `Law tutors aren\'t looking for students who know what the law is. They\'re looking for students who can think about what the law should be.\n\nAnalytical thinking is the single most important quality. Can you read an argument and identify its weaknesses? Can you see both sides of a dispute and understand why reasonable people disagree? Can you take a principle that sounds right in theory and find a situation where it breaks down? That\'s what a law degree trains you to do, and tutors want to see evidence you\'re already doing it naturally.\n\nEngagement with legal ideas, not just legal careers. "I want to be a human rights lawyer" is a career aspiration, not evidence of academic interest. "I read about the tension between free speech and hate speech legislation and found myself disagreeing with the conclusion" is evidence of someone engaging with law as an intellectual discipline. The distinction matters because a law degree is academic, not vocational.\n\nWriting quality. Law is a writing-intensive subject. Your personal statement is itself a writing sample. Spelling mistakes, vague claims, and sloppy arguments aren\'t just bad presentation. They suggest you\'ll struggle with the core skill a law degree demands.`,
    formatGuide: `From 2026 entry onwards, UCAS replaced the freeform essay with three structured questions. You get 4,000 characters total, minimum 350 per question.\n\nQuestion 1 (why law): You need a specific reason, not a generic one. The strongest answers point to a particular legal issue, case, or debate that captured your interest and explain what about it made you want to study law further. If you can connect your interest to something in your own life, even better. Avoid: "Law is the foundation of society." "I have always been passionate about justice." "Watching courtroom dramas inspired me."\n\nQuestion 2 (how your studies prepared you): Show that your current subjects have given you skills relevant to law. English Literature develops close textual analysis. History develops the ability to weigh evidence and construct arguments. Politics develops understanding of how institutions work. Don\'t just list subjects. Explain what specific skill each gave you. If you\'ve done wider reading about law, it belongs here.\n\nQuestion 3 (what you\'ve done outside education): Work experience in law is helpful but most tutors understand it\'s difficult for sixth-formers to get. If you have it, reflect on what you observed. If not, focus on debating, mooting, essay competitions, or volunteering that required communication or problem-solving.`,
    reading: [
      ...
      { title: 'In Your Defence', author: 'Sarah Langford', desc: 'A barrister\'s account of real cases. Gives you specific legal dilemmas to reflect on rather than abstract principles. UCAS specifically suggests this one.' },
      { title: 'In Black and White', author: 'Alexandra Wilson', desc: 'A barrister\'s memoir about race and the justice system. Gives you a distinctive angle on criminal justice that most applicants won\'t have.' },
      { title: 'Justice', author: 'Michael Sandel', desc: 'Accessible introduction to legal and moral philosophy. Good for showing you can engage with the principles underlying law, not just the rules themselves.' },
      { title: 'The Secret Barrister', author: 'Anonymous', desc: 'Insider account of how the criminal justice system actually works. Gives you concrete examples of systemic problems to discuss.' },
    ],
    readingIntro: `The generic recommendation is to read legal non-fiction. That\'s fine as a starting point, but what actually helps is reading anything that presents an argument you can engage with critically. The format matters less than whether it makes you think.\n\nFor criminal justice, books by authors who\'ve worked inside the system give you specific cases and dilemmas to reflect on. For human rights, follow a current case or debate in the news: the tension between national security and civil liberties, the legal framework around refugee claims, the limits of free expression online. Pick one issue and follow it for a few weeks.\n\nFor commercial law, most students ignore this entirely because it sounds boring, but if you\'re interested in how businesses operate, contract disputes, or intellectual property, that\'s a genuinely distinctive angle. Very few personal statements engage with commercial law and tutors notice when one does.\n\nWhatever you read, keep notes. Not summaries but your reactions. Where did you agree? Where did you disagree? What question did it leave you with? Those notes become your personal statement material.`,
    supercurriculars: `Essay competitions are one of the strongest supercurriculars for law applicants because they directly demonstrate the skill tutors care about most: constructing a written legal argument. Landmark Chambers runs essay competitions in human rights law that open annually. The Law Society runs the Graham Turnbull essay competition. Several university law schools run their own competitions open to sixth-form students.\n\nYou don\'t have to win. Entering and being able to discuss the argument you made is what matters. "I entered the Landmark Chambers essay competition on the right to protest and argued that..." gives you something concrete and specific.\n\nMooting (mock legal argument) is harder to access at sixth-form level but some schools and legal organisations run introductory sessions. If yours does, take it. If not, debating societies develop similar skills: constructing arguments under pressure, responding to counterarguments, thinking on your feet.\n\nWork experience in a law firm is useful but not essential. What tutors actually notice is whether you can reflect on what you observed. Sitting in a solicitor\'s office for a week and saying "I learned about conveyancing" is worthless. Noticing that the solicitor spent more time managing client expectations than giving legal advice, and reflecting on what that tells you about legal practice, is much stronger.`,
    examPrep: `The LNAT is required by around 11 universities including Cambridge, Oxford, UCL, KCL, LSE, Bristol, Durham, Glasgow, and Nottingham. If any of your five UCAS choices require the LNAT, you need to prepare for it.\n\nThe LNAT has two sections. Section A is 42 multiple-choice questions based on 12 argumentative passages in 95 minutes. Section B is an essay response to one of three questions in 40 minutes. Total test time is two hours fifteen minutes.\n\nThe LNAT doesn\'t test knowledge of law. It tests whether you can read complex arguments carefully, identify assumptions and flaws, and construct a clear written argument under time pressure.\n\nKey dates for 2027 entry: Registration opens 1 August 2026. Cambridge and Oxford applicants must register by 15 September and sit the test by 15 October 2026. For KCL, LSE, and UCL the deadline is 31 December 2026. Most other LNAT universities require registration by 20 January 2027.\n\nHow universities use LNAT scores varies significantly. Bristol weights it 60% multiple choice, 40% essay, with the LNAT forming 40% of your overall application. LSE only looks at Section A scores. UCL uses a benchmark score based on previous years\' averages, which was 29.4 for those who received offers in 2024/25. Check each university\'s policy before deciding where to apply.`,
    schoolSelection: `You get five UCAS choices. Think carefully about whether you want a traditional lecture-based programme or one with more problem-based learning and clinical modules. Some universities focus heavily on academic law (Oxford, Cambridge, LSE). Others integrate practical skills earlier.\n\nIf you\'re applying to LNAT universities, your score should influence your choices. A student with a strong LNAT and slightly lower predicted grades should target universities that weight the LNAT heavily. A student with strong grades and average LNAT should target universities that weight grades and the personal statement more.\n\nSome universities interview for law, others don\'t. Check each one. If you\'re applying to Cambridge, the interview is a core part of the process and you should prepare for it specifically.`,
    commonMistakes: [
      'Opening with a clich\u00e9 about justice or fairness. "Law is the backbone of civilised society" and its variants appear in thousands of statements every year. Start with something specific instead.',
      'Confusing interest in a legal career with interest in studying law. Tutors are selecting students for an academic degree, not a training contract. Show interest in law as an intellectual discipline first.',
      'Listing books and experiences without engaging with them. "I read In Your Defence and found it very interesting" tells tutors nothing. One specific case from the book that raised a question in your mind tells them everything.',
      'Not preparing for the LNAT. Students who don\'t practise often underperform significantly. The time pressure in Section A catches people off guard.',
      'Applying to LNAT universities without checking how each one uses the score. Some weight it heavily, others barely look at it. This should directly affect your university choices.',
    ],
    howWeHelp: `Tell the AI coach you\'re applying for Law and it tailors everything to what law admissions tutors want. It pushes you to develop analytical arguments rather than generic statements about justice. It suggests reading based on what specifically interests you within law, not just the standard list. It helps you prepare for the LNAT by developing the close-reading and argument-construction skills the test requires. When you\'re ready to write, the Draft Builder pulls your reflections into a structured first draft.`,
  ...
  },
  {
    ...
    whatTutorsLookFor: `Tutors don\'t expect you to understand game theory or monetary policy at degree level. They expect you to look at the world and ask economic questions about it. Why do some products cost more at airports? Why does raising minimum wage sometimes not reduce employment the way textbooks predict? Why do people make financial decisions that seem irrational? If you can take something you\'ve observed in real life and frame it as an economic question, you\'re already thinking like an economist.\n\nMathematical reasoning matters more than most applicants realise. Economics at university level is heavily quantitative. Top programmes (LSE, Cambridge, Warwick, UCL) expect strong maths alongside economics. If you\'re applying to these universities, your maths ability is as important as your interest in the subject. Mention specific mathematical skills or concepts from your A-levels that excite you, not just that you "enjoy problem-solving."\n\nGenuine curiosity beyond the syllabus. Every applicant studies the same A-level content. What tutors want to see is that you\'ve gone further on your own. Read a book that challenged a concept from your course. Found an article that presented an argument you disagreed with. The key is engagement with the material, not just consumption of it.`,
    formatGuide: `From 2026 entry, UCAS replaced the freeform essay with three structured questions. 4,000 characters total, minimum 350 per question. For Economics, spend the majority of your characters on questions 1 and 2. That\'s where your academic engagement lives.\n\nQuestion 1 (why economics): Start with something specific. Not "I\'ve always been interested in how markets work." Maybe a news story about inflation that made you question the trade-offs policymakers face. Maybe growing up in a family business and noticing pricing decisions that didn\'t match what your textbook said. UCAS\'s own guide suggests picking "something slightly more obscure" rather than the books every applicant references. Whatever you reference, have an opinion about it.\n\nQuestion 2 (how your studies prepared you): This is where your maths background matters. Talk about specific areas that connect to economics: statistical analysis, probability, calculus. If you\'ve done an EPQ related to economics, discuss it here. Draw connections from other subjects too. History teaches you to evaluate competing explanations. Psychology introduces behavioural concepts that challenge classical assumptions.\n\nQuestion 3 (outside education): One strong example beats three weak ones. If you\'ve entered the Royal Economic Society essay competition, talk about your argument. If you\'ve done a MOOC, talk about one concept that challenged your thinking. If you have a part-time job, connect something you observed to economic theory.`,
    workExperience: `BSc vs BA Economics is a distinction most applicants overlook. Some universities offer BSc Economics (more quantitative, heavier on maths and statistics) and others offer BA Economics (broader, more room for qualitative analysis and policy). Some offer both.\n\nIf you\'re studying Further Maths and enjoy the quantitative side, BSc programmes at LSE, UCL, or Warwick will suit you. If you\'re more interested in economic policy, history of economic thought, or development economics, BA programmes or joint honours courses might be a better fit.\n\nThis matters for your personal statement because the skills and interests you emphasise should match the type of programme you\'re applying to. A BSc-focused statement should demonstrate mathematical aptitude. A BA-focused statement can lean more into policy debates and theoretical arguments.`,
    reading: [
      { title: 'Why Nations Fail', author: 'Acemoglu & Robinson', desc: 'The argument that institutions, not geography or culture, determine economic outcomes gives you a rich thread to pull on. Connect it to specific countries, challenge it with counterexamples, link it to current policy debates.' },
      { title: 'Misbehaving', author: 'Richard Thaler', desc: 'Goes deeper than Nudge into how behavioural economics challenged classical assumptions. The tension between rational actor models and real human behaviour connects to almost every area of economics.' },
      { title: 'The Economics of Inequality', author: 'Thomas Piketty', desc: 'The shorter one, not Capital. Accessible, specific, and gives you concrete arguments about redistribution, taxation, and what "fair" means in economic terms.' },
      { title: 'Everything Is Predictable', author: 'Tom Chivers', desc: 'UCAS specifically recommends this. Covers Bayesian thinking and probability. Unusual enough that mentioning it signals you\'ve gone beyond the standard reading list.' },
      { title: 'The Undercover Economist', author: 'Tim Harford', desc: 'Solid introduction to microeconomic thinking. Better than Freakonomics for personal statements because the arguments are more directly connected to core economic concepts.' },
    ],
    readingIntro: `The standard recommendations are Freakonomics, The Undercover Economist, and Thinking, Fast and Slow. These are fine books but they\'re on every applicant\'s list. If you mention one, you need to go deeper than a summary.\n\nBeyond books: The Economist, the FT, and podcasts like More or Less (BBC) or Planet Money (NPR) keep you engaged with current economic debates. Being able to reference a recent policy decision or economic event shows you\'re paying attention to economics as a living subject.\n\nCORE Econ\'s "The Economy" is designed specifically as an introduction to university-level economics and is used by several UK universities in their first year. Completing even part of it gives you genuine talking points about economic models and their limitations.`,
    supercurriculars: `The Royal Economic Society runs an annual essay competition for students. It\'s one of the strongest things you can put on an Economics application because it directly demonstrates constructing an economic argument in writing. Check their website for the current year\'s topic and deadline.\n\nThe Bank of England\'s educational resources and competitions are worth looking into. Some schools participate in the Target Two Point Zero competition, which simulates monetary policy decisions.\n\nIf you can\'t find a formal competition, write something independently. A blog post analysing a current economic issue. A short essay responding to an argument from a book you\'ve read. The act of writing about economics, and being able to reference it in your statement, is what matters.\n\nMOOCs can be valuable if you pick the right one. CORE Econ\'s "The Economy" is the strongest choice. Completing even part of it and discussing a specific model or concept it introduced you to is more impressive than listing three courses you barely remember.`,
    examPrep: `The TMUA (Test of Mathematics for University Admission) is used by several top universities for Economics, including Cambridge, LSE, Imperial, Warwick, Durham, and UCL. If any of your UCAS choices are on this list, you need to prepare.\n\nThe TMUA tests mathematical reasoning and problem-solving, not memorised formulas. It assesses whether you can think mathematically in unfamiliar situations. You can sit it in October or January, but only your first score counts. Cambridge and Oxford applicants must take the October sitting.\n\nRegistration opens 20 July 2026. The October sitting runs 12-16 October. The January sitting runs 4-8 January. Start preparing 4-6 weeks before. Practice papers are on the UAT-UK website.\n\nImportant: not all Economics programmes require the TMUA. Many excellent universities don\'t use it at all. If your maths is strong, target TMUA universities to make it an advantage. If maths isn\'t your strongest subject, you still have plenty of strong programmes to choose from.`,
    schoolSelection: `Economics is offered at nearly every UK university but the programmes vary enormously. Research whether maths is integrated into the course or taught separately. Whether the programme requires TMUA, and how heavily it\'s weighted. Whether the programme leans quantitative (LSE, Cambridge, Warwick, UCL) or allows more breadth.\n\nWhether they interview. Cambridge and some Oxford courses (PPE, Economics and Management) interview. Most other universities make offers based on your application alone.\n\nIf you\'re applying to quantitative programmes and your statement doesn\'t mention mathematical skills or enthusiasm for quantitative analysis, that\'s a red flag. Tutors will wonder if you know what you\'re signing up for.`,
    commonMistakes: [
      'Writing a personal statement that could apply to any social science. If you could swap "economics" for "politics" and it still works, it\'s not specific enough. Every claim should connect to an economic concept, model, or question.',
      'Neglecting the maths angle. If you\'re applying to quantitative programmes without mentioning mathematical skills, tutors will wonder if you know what you\'re signing up for.',
      'Referencing Freakonomics without going deeper. It\'s the most commonly cited book on Economics statements. A vague "it showed me economics is everywhere" line actively hurts you because it signals surface-level reading.',
      'Confusing interest in business with interest in economics. Economics is an academic discipline. If your statement reads like you want to study business management, you\'re applying for the wrong course.',
      'Not preparing for the TMUA when applying to universities that use it. Students who don\'t practise often score significantly below their potential.',
    ],
    howWeHelp: `Tell the AI coach you\'re applying for Economics and it tailors everything to what economics departments want. It pushes you to develop specific economic arguments rather than generic claims about markets. It suggests reading based on what area of economics interests you most, not just the standard list. It helps you connect your maths skills to economic thinking. When you\'re ready to write, the Draft Builder pulls your reflections into a structured first draft.`,
    relatedSubjects: ['ppe', 'maths', 'politics'],
  },
  {
