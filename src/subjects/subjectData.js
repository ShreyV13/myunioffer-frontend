...
export const subjects = [
  {
    ...
    heroHook: 'Medicine is one of the most competitive UCAS courses. Here\'s what actually matters in your application and what\'s a waste of your time.',
    whatTutorsLookFor: `Medicine admissions tutors read hundreds of personal statements every cycle. They're not looking for a list of work experience placements or a paragraph about wanting to help people. Every applicant says that.

What separates strong applicants is reflection. Not describing what you saw during shadowing, but what it made you think about medicine as a career. A student who spent two days in a GP surgery and can describe a specific moment where they noticed something about doctor-patient communication is more interesting than someone who did two weeks in a hospital and can only say it was "eye-opening."

Tutors also want to see genuine academic engagement with science beyond the A-level syllabus. Not just naming a book you read, but engaging with a specific idea from it. What did you find surprising? What did you disagree with? Where does the science connect to what you've seen in a clinical setting?

The third thing they look for is evidence that you understand what being a doctor actually involves. Long hours, emotional difficulty, bureaucracy, ethical dilemmas. Students who only talk about the glamorous side of medicine, the surgery and the breakthroughs, haven't thought deeply enough about the reality of the career.`,
    reading: [
      { title: 'Being Mortal', author: 'Atul Gawande', desc: 'Challenges assumptions about end-of-life care and what medicine can and should do. Overused in personal statements, but if you engage critically with Gawande\'s argument rather than just summarising it, it still works.' },
      ...
      { title: 'The Man Who Mistook His Wife for a Hat', author: 'Oliver Sacks', desc: 'Neurological case studies that raise questions about identity, consciousness, and what it means to be a patient. Useful for showing you think about the human side of medicine, not just the science.' },
      { title: 'This is Going to Hurt', author: 'Adam Kay', desc: 'A junior doctor\'s diary. Funny but also brutally honest about NHS working conditions. Good for demonstrating you understand the reality of the job, not just the idealised version.' },
      { title: 'Bad Pharma', author: 'Ben Goldacre', desc: 'How drug companies mislead doctors and patients. Gives you something to say about evidence-based medicine and why clinical trials matter. Less commonly mentioned than his other book, Bad Science.' },
    ],
...
Hospice and care home volunteering tends to produce better reflection material than hospital shadowing because you get actual patient contact. In hospitals, you mostly observe from a distance.

Specific recommendations: the Nuffield Research Placement scheme if you can get one (competitive but free, real lab work). The Medic Mentor programme for structured work experience guidance. Healthcare podcasts like Inside Health (BBC) where you can reference a specific episode and engage with the topic. The BMA medical ethics toolkit for understanding frameworks you'll need in interviews.

EPQs work well for Medicine if the topic is genuinely interesting to you. "The ethics of organ donation" is overdone. "Whether GP surgeries should screen for depression during routine appointments" is more specific and shows you've thought about primary care, which most applicants ignore entirely.`,
    commonMistakes: [
      'Spending a paragraph describing what you saw during work experience without reflecting on what it taught you about being a doctor. "I observed a knee replacement surgery" tells admissions tutors nothing.',
      'Opening with "I have always wanted to be a doctor since I was young." This is the single most common opening line in Medicine personal statements. It says nothing specific about you.',
      'Only mentioning hospital-based experiences. Medicine is mostly primary care, community health, and chronic disease management. Show you know that.',
      'Name-dropping five books without engaging with any of them. One book discussed properly is worth more than a reading list.',
    ],
    howWeHelp: `Tell the AI coach you're applying for Medicine and it tailors everything to what medical schools actually want. It'll ask about your work experience and push you to reflect on specific moments, not just describe what happened. It suggests reading based on what specifically interests you within medicine, not just the standard list everyone uses. As you chat over weeks, it stores your experiences and reflections. When you're ready to write, the Draft Builder pulls everything together into a structured first draft that sounds like you, not like a template.`,
  },
  {
    slug: 'law',
    name: 'Law',
