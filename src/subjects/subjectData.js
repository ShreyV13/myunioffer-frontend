...
Podcasts and lectures: the London Review of Books podcast and the British Library's English and drama resources are freely available and give you access to current literary thinking.`,
  ...
  },
  {
    ...
    howWeHelp: `Tell the AI coach you\'re applying for Mathematics and it pushes you to articulate what specifically fascinates you about maths beyond the syllabus. It suggests problem sources and reading based on your interests. It helps you prepare for TMUA by developing the reasoning skills the test requires. When you\'re ready to write, the Draft Builder structures your reflections into a first draft.`,
    relatedSubjects: ['computer-science', 'physics', 'economics'],
  },
  {
    slug: 'physics',
    name: 'Physics',
...
Podcasts like In Our Time (BBC) cover historical topics in depth with academic experts. Referencing a specific episode and engaging with the debate it presents shows independent intellectual engagement.`,
  ...
  },
  {
    ...
    howWeHelp: `Tell the AI coach you\'re applying for PPE and it pushes you to connect ideas across philosophy, politics, and economics rather than treating them separately. It suggests reading that spans disciplines. It helps develop the argument skills the TARA requires. The Draft Builder structures your reflections into a first draft.`,
