...
export default function About() {
  ...
  const team = [
    { 
      ...
      contribution: "Built the entire AI coaching system. Designed the AI coaching system. Curated the Economics and Humanities interview questions and personal statement database. Covers all humanities and social science applications.",
      confirmed: true
    },
    { 
      name: "Recruiting", 
    ...
    { 
      ...
      bio: "We're looking for an arts student from a UK university. Someone who understands portfolio-based applications, creative interviews, and how to showcase artistic vision in personal statements.",
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        >
          <div className="card p-8 text-center bg-gray-50 border-gray-100">
            <h3 className="text-xl font-display font-bold text-gray-900 mb-2">Are you a current university student?</h3>
        ...
        >
          <div className="card p-8 text-center">
            <h3 className="text-xl font-display font-bold text-gray-900 mb-2">Need help?</h3>
            <p className="text-gray-600 text-sm mb-4 max-w-lg mx-auto">
              Whether you have a question about the AI or need help with your account, just email us. Cancellations and refunds handled quickly, no questions asked.
            </p>
            ...
            <p className="text-gray-400 text-xs mt-3">Cancel anytime · We respond within 24 hours</p>
          </div>
        </motion.div>
