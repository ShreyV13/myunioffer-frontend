    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-12">
      ...
      >
        ...
        <div className="card p-8">
          <h1 className="text-2xl font-display font-bold text-center mb-2 text-gray-900">Reset password</h1>
          <p className="text-gray-500 text-center mb-8">We'll send you a link to reset your password</p>
        ...
        <Link to="/login" className="flex items-center justify-center gap-2 text-gray-600 mt-6 hover:text-coral-600">
