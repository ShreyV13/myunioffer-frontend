        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="https://www.linkedin.com/in/shrey-verma-669a87284" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-gray-400 hover:text-[#0A66C2] transition-colors" title="Follow for launch updates">
          ...
          {mobileMenu && (
            <div className="md:hidden mt-4 pb-4 border-t border-gray-100 pt-4 flex flex-col gap-4">
              ...
              <a href="https://www.linkedin.com/in/shrey-verma-669a87284" target="_blank" rel="noopener noreferrer" onClick={() => setMobileMenu(false)} className="flex items-center gap-2 text-[#0A66C2] font-medium">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-white border border-gray-200 rounded-full text-sm text-gray-600 hover:border-[#0A66C2] hover:text-[#0A66C2] transition-all duration-200 shadow-sm"
            >
              <svg className="w-4 h-4 fill-[#0A66C2]" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              Follow for launch date & early access updates
            </a>
          </motion.div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div style={{columns: '2', columnGap: '12px'}}>
            {[
              ...
              <motion.div
                key={i}
                className="mb-3 rounded-2xl overflow-hidden shadow-lg border border-gray-100"
              ...
              >
                <img src={t.src} alt="Beta tester feedback" className="w-full h-auto block" />
              </motion.div>
            ))}
          </div>
        </div>
