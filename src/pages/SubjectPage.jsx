...
function Label({ text }) {
  return <p style={{ fontSize: "0.62rem", fontWeight: 800, letterSpacing: "0.22em", textTransform: "uppercase", color: coral, margin: "0 0 1rem" }}>{text}</p>;
}

function Line() {
  return <div style={{ height: 1, background: "rgba(0,0,0,0.07)", margin: "0 auto", maxWidth: 1400 }} />;
}
...
export default function SubjectPage() {
  ...
  const { name, heroHook, color = coral, accentColor = coralEnd, whatTutorsLookFor, reading = [], supercurriculars: supercurricularsRaw, commonMistakes: commonMistakesRaw = [], howWeHelp: howWeHelpRaw, relatedSubjects = [] } = data;
  ...
  // Extract a strong sentence for the pull quote
  ...
  return (
    <div style={{ background: "#fff", color: "#1a1a1a", overflowX: "hidden", ...S }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 2rem", height: 52, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.35rem", fontSize: "0.78rem", color: "rgba(0,0,0,0.3)" }}>
            ...
            <ChevronRight size={11} />
            <span style={{ color: "#1a1a1a", fontWeight: 600 }}>{name}</span>
          </div>
      ...
      <section ref={heroRef} style={{ minHeight: "90vh", display: "flex", alignItems: "flex-end", position: "relative", overflow: "hidden" }}>
        {/* Subtle coral wash top-right */}
        <div style={{ position: "absolute", top: "-10%", right: "-8%", width: "50vw", height: "50vw", maxWidth: 700, maxHeight: 700, borderRadius: "50%", background: coral, opacity: 0.04, filter: "blur(100px)", pointerEvents: "none" }} />
        ...
        <motion.div style={{ opacity: heroOpacity, scale: heroScale, width: "100%", position: "relative", zIndex: 2, maxWidth: 1400, margin: "0 auto", padding: "0 2rem 5rem" }}>
          ...
          {/* Title */}
          <h1 style={{ ...D, fontSize: "clamp(4rem, 12vw, 11rem)", fontWeight: 800, lineHeight: 0.88, letterSpacing: "-0.045em", margin: "0 0 2.5rem", color: "#1a1a1a" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-end", justifyContent: "space-between", gap: "2rem" }}>
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4, duration: 0.7 }}
              style={{ fontSize: "clamp(1rem, 1.7vw, 1.2rem)", color: "rgba(0,0,0,0.42)", lineHeight: 1.6, maxWidth: 500, margin: 0 }}
            >{heroHook}</motion.p>
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55, duration: 0.6 }}
              ...
              <Magnetic onClick={() => navigate(`/signup?subject=${slug}`)} style={{
                ...
                background: `linear-gradient(135deg, ${coral}, ${coralEnd})`, border: "none", cursor: "pointer",
                color: "#fff", fontWeight: 700, fontSize: "0.92rem", padding: "0.85rem 1.6rem", borderRadius: "0.75rem",
                boxShadow: `0 4px 24px ${coral}25`,
              ...
              <Magnetic onClick={() => navigate("/rate-my-ps")} style={{
                ...
                color: "rgba(0,0,0,0.5)", fontWeight: 600, fontSize: "0.92rem", padding: "0.85rem 1.6rem", borderRadius: "0.75rem",
              }}>Rate my PS</Magnetic>
            </motion.div>
          </div>
        </motion.div>
      ...
      <section style={{ maxWidth: 1400, margin: "0 auto", padding: "7rem 2rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "start" }}>
          <div style={{ position: "sticky", top: 76 }}>
            <Reveal>
              <Label text="What tutors actually look for" />
              <h2 style={{ ...D, fontSize: "clamp(2.2rem, 4.5vw, 3.8rem)", fontWeight: 800, letterSpacing: "-0.04em", lineHeight: 1.02, margin: 0 }}>
                The real criteria.
                <br />
                <span style={{ color: coral }}>Not the prospectus version.</span>
              </h2>
            </Reveal>
            <Reveal delay={0.15}>
              <p style={{ fontSize: "0.88rem", color: "rgba(0,0,0,0.35)", lineHeight: 1.7, maxWidth: 370, marginTop: "1.4rem" }}>
            ...
            {tutorParas.map((para, i) => (
              <div key={i}>
                {i === 1 && pullQuote && (
                  <Reveal>
                    <blockquote style={{
                      margin: "2.5rem 0", padding: "1.8rem 0 1.8rem 1.8rem",
                      borderLeft: `3px solid ${coral}`,
                      ...D, fontSize: "clamp(1.15rem, 2vw, 1.45rem)", fontWeight: 500,
                      lineHeight: 1.5, color: "rgba(0,0,0,0.58)", fontStyle: "italic",
                    }}>{pullQuote}</blockquote>
                  </Reveal>
                )}
                <Reveal delay={i * 0.04}>
                  <p style={{ fontSize: "1rem", color: "rgba(0,0,0,0.52)", lineHeight: 1.85, marginBottom: "1.8rem" }}>{para}</p>
                </Reveal>
              </div>
            ))}
          </div>
      ...
      <section style={{ padding: "0 2rem", maxWidth: 1400, margin: "0 auto" }}>
        <Reveal>
          <div style={{
            borderRadius: "1.1rem", padding: "2.5rem 2.2rem",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
          {books.map((book, i) => (
            <Reveal key={i} delay={i * 0.03}>
              <motion.div
                whileHover={{ x: 8, background: "rgba(0,0,0,0.02)" }}
                transition={{ type: "spring", stiffness: 300, damping: 25 }}
                style={{
                  display: "grid", gridTemplateColumns: "3rem 1fr", gap: "1.2rem",
                  padding: "1.3rem 1.4rem", borderRadius: "0.9rem",
              ...
              >
                ...
                <div>
                  <div style={{ display: "flex", flexWrap: "wrap", alignItems: "baseline", gap: "0.45rem", marginBottom: "0.3rem" }}>
                    ...
                    {book.author && <span style={{ fontSize: "0.8rem", color: "rgba(0,0,0,0.32)" }}>{book.author}</span>}
                  </div>
                  <p style={{ fontSize: "0.84rem", color: "rgba(0,0,0,0.42)", lineHeight: 1.65, margin: 0 }}>{book.note}</p>
                </div>
              </motion.div>
            </Reveal>
          ))}
      ...
      {/* ── Supercurriculars (columns flipped) ─────────────────────────── */}
      <section style={{ maxWidth: 1400, margin: "0 auto", padding: "7rem 2rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "start" }}>
          <div>
          ...
          <div style={{ position: "sticky", top: 76 }}>
            ...
            <Reveal delay={0.2}>
              <Magnetic onClick={() => navigate(`/signup?subject=${slug}`)} style={{
                display: "inline-flex", alignItems: "center", gap: "0.4rem", marginTop: "1.8rem",
                background: "transparent", border: `1px solid ${coral}35`, cursor: "pointer",
                color: coral, fontWeight: 700, fontSize: "0.82rem", padding: "0.65rem 1.2rem", borderRadius: "0.6rem",
              }}>Get personalised advice <ArrowUpRight size={13} /></Magnetic>
            </Reveal>
          </div>
        </div>
      </section>
            ...
            return (
              <Reveal key={i} delay={i * 0.05}>
                <motion.div
                  ...
                  style={{
                    display: "grid", gridTemplateColumns: "4rem 1fr", gap: "0.6rem",
                    padding: "1.8rem", borderRadius: "1rem",
                    background: `${coral}05`, border: `1px solid ${coral}0e`,
                    height: "100%",
                  }}
                >
                  <span style={{ ...D, fontSize: "3rem", fontWeight: 800, lineHeight: 1, color: `${coral}18` }}>{String(i + 1).padStart(2, "0")}</span>
                  <p style={{ fontSize: "0.9rem", color: "rgba(0,0,0,0.52)", lineHeight: 1.75, margin: 0, alignSelf: "center" }}>{text}</p>
                </motion.div>
              </Reveal>
            );
          })}
      ...
      <section style={{ maxWidth: 1400, margin: "0 auto", padding: "7rem 2rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
          <div>
            <Reveal>
              <Label text="How myunioffer ai helps" />
              <h2 style={{ ...D, fontSize: "clamp(2.2rem, 4.5vw, 3.8rem)", fontWeight: 800, letterSpacing: "-0.04em", lineHeight: 1.02, margin: "0 0 1.8rem" }}>
                Your {name} coach.
              </h2>
            </Reveal>
            <Reveal delay={0.08}>
              <p style={{ fontSize: "1rem", color: "rgba(0,0,0,0.48)", lineHeight: 1.85, marginBottom: "2.2rem" }}>{helpText}</p>
            </Reveal>
            <Reveal delay={0.16}>
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.55rem" }}>
                <Magnetic onClick={() => navigate(`/signup?subject=${slug}`)} style={{
                  ...
                  background: `linear-gradient(135deg, ${coral}, ${coralEnd})`, border: "none", cursor: "pointer",
                  color: "#fff", fontWeight: 700, fontSize: "0.88rem", padding: "0.8rem 1.5rem", borderRadius: "0.7rem",
                  boxShadow: `0 4px 20px ${coral}20`,
                }}>Start free coaching <ArrowRight size={14} /></Magnetic>
                <Magnetic onClick={() => navigate("/rate-my-ps")} style={{
                  background: "transparent", border: "1px solid rgba(0,0,0,0.1)", cursor: "pointer",
                  color: "rgba(0,0,0,0.48)", fontWeight: 600, fontSize: "0.88rem", padding: "0.8rem 1.5rem", borderRadius: "0.7rem",
          ...
          {/* Chat preview */}
          <Reveal delay={0.1}>
            <div style={{ borderRadius: "1.1rem", overflow: "hidden", border: "1px solid rgba(0,0,0,0.08)", background: "#1a1a1a", boxShadow: "0 20px 60px rgba(0,0,0,0.12)" }}>
              <div style={{ padding: "0.6rem 0.9rem", background: "rgba(255,255,255,0.04)", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", gap: "0.45rem" }}>
                <div style={{ display: "flex", gap: "0.25rem" }}>
                  <div style={{ width: 7, height: 7, borderRadius: "50%", background: "#ff5f57" }} />
                  <div style={{ width: 7, height: 7, borderRadius: "50%", background: "#febc2e" }} />
                  <div style={{ width: 7, height: 7, borderRadius: "50%", background: "#28c840" }} />
                </div>
                <span style={{ fontSize: "0.65rem", color: "rgba(255,255,255,0.25)", fontWeight: 600, marginLeft: "0.3rem" }}>myunioffer ai</span>
              ...
              <div style={{ padding: "1rem", display: "flex", flexDirection: "column", gap: "0.65rem", minHeight: 260 }}>
                <div style={{ display: "flex", justifyContent: "flex-end" }}>
                  <div style={{ background: coral, borderRadius: "0.9rem 0.9rem 0.25rem 0.9rem", padding: "0.55rem 0.8rem", maxWidth: "72%", fontSize: "0.78rem", lineHeight: 1.5, color: "#fff" }}>
                    I'm applying for {name} but I'm not sure what to write about.
                  </div>
                </div>
                <div style={{ display: "flex", justifyContent: "flex-start" }}>
                  <div style={{ background: "rgba(255,255,255,0.06)", borderRadius: "0.9rem 0.9rem 0.9rem 0.25rem", padding: "0.55rem 0.8rem", maxWidth: "78%", fontSize: "0.78rem", lineHeight: 1.5, color: "rgba(255,255,255,0.72)" }}>
                    That's normal at this stage. Have you had any experiences or reading about {name.toLowerCase()} that genuinely made you think?
                  </div>
                </div>
                <div style={{ display: "flex", justifyContent: "flex-end" }}>
                  <div style={{ background: coral, borderRadius: "0.9rem 0.9rem 0.25rem 0.9rem", padding: "0.55rem 0.8rem", maxWidth: "72%", fontSize: "0.78rem", lineHeight: 1.5, color: "#fff" }}>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end" }}>
                  <motion.div animate={{ opacity: [0.3, 0.65, 0.3] }} transition={{ duration: 1.5, repeat: Infinity }}
                    style={{ background: `${coral}55`, borderRadius: "0.8rem", padding: "0.4rem 0.7rem", fontSize: "0.72rem", color: "rgba(255,255,255,0.45)" }}>...</motion.div>
                </div>
              </div>
            </div>
          </Reveal>
      ...
      {relatedSubjects.length > 0 && (
        <>
          <Line />
          <section style={{ padding: "3rem 2rem 3.5rem", maxWidth: 1400, margin: "0 auto" }}>
            <Reveal style={{ marginBottom: "1rem" }}>
              <h3 style={{ ...D, fontWeight: 700, fontSize: "0.95rem", margin: 0, color: "rgba(0,0,0,0.4)" }}>Explore other subjects</h3>
            </Reveal>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "0.4rem" }}>
              {relatedSubjects.map((s, i) => (
                <Reveal key={s} delay={i * 0.025}>
                  <Link to={`/subjects/${s}`} style={{ textDecoration: "none" }}>
                    <motion.div whileHover={{ scale: 1.05, borderColor: "rgba(0,0,0,0.18)" }}
                      transition={{ type: "spring", stiffness: 320, damping: 22 }}
                      style={{ padding: "0.4rem 0.85rem", borderRadius: "0.5rem", border: "1px solid rgba(0,0,0,0.09)", color: "rgba(0,0,0,0.48)", fontSize: "0.8rem", fontWeight: 600, textTransform: "capitalize" }}>
                      {s.replace(/-/g, " ")}
                    </motion.div>
                  </Link>
                </Reveal>
      ...
      <section style={{ padding: "0 2rem", maxWidth: 1400, margin: "0 auto" }}>
        <Reveal>
          <div style={{
            borderRadius: "1.4rem", padding: "5rem 3rem", textAlign: "center",
            background: `linear-gradient(135deg, ${coral}, ${coralEnd})`,
            position: "relative", overflow: "hidden",
          }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <h2 style={{ ...D, fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, color: "#fff", lineHeight: 1, margin: "0 0 0.8rem" }}>
              ...
              <Magnetic onClick={() => navigate(`/signup?subject=${slug}`)} style={{
                ...
                color: coralEnd, fontWeight: 700, fontSize: "1rem", padding: "0.95rem 2rem", borderRadius: "0.75rem",
